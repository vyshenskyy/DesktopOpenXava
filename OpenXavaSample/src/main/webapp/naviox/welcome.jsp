...
In OpenXavaSample-labels_en.properties:
OpenXavaSample=My application
OpenXavaSample[description]=My application does this and that

In OpenXavaSample-messages_en.properties:
